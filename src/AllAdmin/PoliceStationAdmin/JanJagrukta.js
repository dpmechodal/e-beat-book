                    ...
                    <div className="col-12 mb-24">
                        <div className="bg-box">
                            <div className="pro-add-new px-0">
                                <p>जन-जागरुकता कार्यक्रमों की संख्या व स्थान</p>
                            ...
                            <div className='responsive-table'>
                                <table className="table">
                                    <thead>
                                        <tr>
                                            <th>No</th>                                    
                                            <th>जन-जागरुकता कार्यक्रमों की संख्या व स्थान</th>
                                            <th>Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td>1</td>                                  
                                            <td>जन-जागरुकता कार्यक्रमों की संख्या व स्थान</td>
                                            <td>
                        ...
                        <div className="user-details">
                            <form className='row'>
                                <div className="mb-3 col-12">
                                    <label className='mb-2'>जन-जागरुकता कार्यक्रमों की संख्या व स्थान</label>
                                    <input type="text" className="form-control" placeholder='जन-जागरुकता कार्यक्रमों की संख्या व स्थान'/>
                                </div>
