                        ...
                        <div className="user-details">
                            <form className='row'>
                                <div className="mb-3 col-12">
                                    <label className='mb-2'>निस्तारण का विवरण</label>
                                    <input type="text" className="form-control" placeholder='निस्तारण का विवरण'/>
                                </div>
