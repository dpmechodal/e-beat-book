                    ...
                    <div className="col-12 mb-24">
                        <div className="bg-box">
                            <div className="pro-add-new px-0">
                                <p>प्रचार-प्रसार हेतु भ्रमण की संख्या</p>
                            ...
                            <div className='responsive-table'>
                                <table className="table">
                                    <thead>
                                        <tr>
                                            <th>No</th>                                    
                                            <th>प्रचार-प्रसार हेतु भ्रमण की संख्या</th>
                                            <th>Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td>1</td>                                  
                                            <td>प्रचार-प्रसार हेतु भ्रमण की संख्या</td>
                                            <td>
                        ...
                        <div className="user-details">
                            <form className='row'>
                                <div className="mb-3 col-12">
                                    <label className='mb-2'>प्रचार-प्रसार हेतु भ्रमण की संख्या</label>
                                    <input type="text" className="form-control" placeholder='प्रचार-प्रसार हेतु भ्रमण की संख्या'/>
                                </div>
